...
const blog = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2  gap-4 my-20'>
            <div className="card w-96 bg-gray-400 text-primary-content">
            ...
            <div className="card w-96 bg-cyan-400 text-primary-content">
            <div className="card-body">
            ...
            <div className="card w-96 bg-yellow-400 text-primary-content">
            <div className="card-body">
